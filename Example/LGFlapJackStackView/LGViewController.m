...
- (void)viewDidLoad {
    ...
    for (int i = 0; i<12; i++) {
        ...
        flapJack.leftBarTotal = [NSNumber numberWithInt:[self getRandomNumberBetween:0 to:0]];
        flapJack.rightBarTotal = [NSNumber numberWithInt:[self getRandomNumberBetween:0 to:0]];
